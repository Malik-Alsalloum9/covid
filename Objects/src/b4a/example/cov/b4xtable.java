...
public class b4xtable extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.cov.b4xtable");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.example.cov.b4xtable.class).invoke(this, new Object[] {null});
        else
...
public b4a.example.cov.b4xformatter _defaultformatter = null;
public b4a.example.cov.b4xformatter _defaultdataformatter = null;
...
public b4a.example.cov.b4xfloattextfield _searchfield = null;
...
public b4a.example.cov.b4xformatter Formatter;
public String SQLID;
public int Width;
...
Sortable = false;
Searchable = false;
Formatter = new b4a.example.cov.b4xformatter();
SQLID = "";
Width = 0;
ComputedWidth = 0;
...
public b4a.example.cov.b4xtable._b4xtablecolumn  _addcolumn(String _title,int _columntype) throws Exception{
b4a.example.cov.b4xtable._b4xtablecolumn _c = null;
...
_c = new b4a.example.cov.b4xtable._b4xtablecolumn();
...
_c.Formatter /*b4a.example.cov.b4xformatter*/  = _defaultdataformatter;
...
public String  _addcolumntoclv(b4a.example.cov.b4xtable._b4xtablecolumn _c) throws Exception{
...
_c = (b4a.example.cov.b4xtable._b4xtablecolumn)(group1.Get(index1));
...
_c = (b4a.example.cov.b4xtable._b4xtablecolumn)(group5.Get(index5));
...
_c = (b4a.example.cov.b4xtable._b4xtablecolumn)(group19.Get(index19));
...
_c = (b4a.example.cov.b4xtable._b4xtablecolumn)(group3.Get(index3));
...
_c = (b4a.example.cov.b4xtable._b4xtablecolumn)(group11.Get(index11));
...
public ResumableSub_CellClicked(b4a.example.cov.b4xtable parent,anywheresoftware.b4a.objects.B4XViewWrapper _pnl,boolean _longclicked) {
this.parent = parent;
this._pnl = _pnl;
this._longclicked = _longclicked;
}
b4a.example.cov.b4xtable parent;
anywheresoftware.b4a.objects.B4XViewWrapper _pnl;
boolean _longclicked;
b4a.example.cov.b4xtable._b4xtablecolumn _column = null;
int _row = 0;
String _e = "";
long _rowid = 0L;
int _clr = 0;
...
_column = (b4a.example.cov.b4xtable._b4xtablecolumn)(_pnl.getParent().getTag());
...
public String  _checkandremovecolumnthatwasaddedtoincorrectparent(b4a.example.cov.b4xtable._b4xtablecolumn _c,boolean _isfrozen) throws Exception{
...
_defaultformatter = new b4a.example.cov.b4xformatter();
_defaultdataformatter = new b4a.example.cov.b4xformatter();
...
_searchfield = new b4a.example.cov.b4xfloattextfield();
...
public ResumableSub_Clear(b4a.example.cov.b4xtable parent) {
this.parent = parent;
}
b4a.example.cov.b4xtable parent;
...
if (index4 < groupLen4) {
this.state = 3;
_c = (b4a.example.cov.b4xtable._b4xtablecolumn)(group4.Get(index4));}
if (true) break;
...
parent.__c.LogImpl("917891349","closing old db.",0);
...
public String  _columntosqltype(b4a.example.cov.b4xtable._b4xtablecolumn _c) throws Exception{
...
public String  _createcolumnlayouts(b4a.example.cov.b4xtable._b4xtablecolumn _c,int _size) throws Exception{
int _i = 0;
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
...
;
for (; index5 < groupLen5;index5++){
_column = (b4a.example.cov.b4xtable._b4xtablecolumn)(group5.Get(index5));
...
public ResumableSub_DesignerCreateView(b4a.example.cov.b4xtable parent,Object _base,anywheresoftware.b4a.objects.LabelWrapper _lbl,anywheresoftware.b4a.objects.collections.Map _props) {
this.parent = parent;
this._base = _base;
this._lbl = _lbl;
this._props = _props;
...
parent._mbase.setObject((java.lang.Object)(_base));
...
_jo.setObject((java.lang.Object)(parent._searchfield._gettextfield /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().getObject()));
...
public b4a.example.cov.b4xtable._b4xtablecolumn  _getcolumn(String _columnid) throws Exception{
b4a.example.cov.b4xtable._b4xtablecolumn _c = null;
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getlabelfromcolumn(b4a.example.cov.b4xtable._b4xtablecolumn _c,int _index) throws Exception{
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
...
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
_p.setObject((java.lang.Object)(_c.CellsLayouts /*anywheresoftware.b4a.objects.collections.List*/ .Get(_index)));
...
_rs.setObject((android.database.Cursor)(_sql1.ExecQuery2("SELECT * FROM data WHERE rowid = ?",new String[]{BA.NumberToString(_rowid)})));
...
public String  _headerclicked(b4a.example.cov.b4xtable._b4xtablecolumn _col) throws Exception{
b4a.example.cov.b4xtable._b4xtablecolumn _c = null;
...
_c = (b4a.example.cov.b4xtable._b4xtablecolumn)(group2.Get(index2));
...
public ResumableSub_ImplUpdateDataFromQuery(b4a.example.cov.b4xtable parent,String _query,Object _args,int _totalcount,boolean _dontsleep) {
this.parent = parent;
this._query = _query;
this._args = _args;
...
_rs = new anywheresoftware.b4a.sql.SQL.ResultSetWrapper();
_rs.setObject((android.database.Cursor)(parent._sql1.ExecQuery2(_query,(String[])(_args))));
...
this.state = 22;
_c = (b4a.example.cov.b4xtable._b4xtablecolumn)(group17.Get(index17));}
if (true) break;
...
_c.Formatter /*b4a.example.cov.b4xformatter*/ ._formatlabel /*String*/ (_rs.GetDouble(_c.SQLID /*String*/ ),_lbl);
 if (true) break;
...
this.state = 38;
_c = (b4a.example.cov.b4xtable._b4xtablecolumn)(group33.Get(index33));}
if (true) break;
...
parent.__c.LogImpl("918874438",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
;
...
_c = (b4a.example.cov.b4xtable._b4xtablecolumn)(group24.Get(index24));
...
_c = (b4a.example.cov.b4xtable._b4xtablecolumn)(_visiblecolumns.Get(_i));
...
public String  _removecolumnfromclv(b4a.example.cov.b4xtable._b4xtablecolumn _c) throws Exception{
int _i = 0;
...
if ((_c).equals((b4a.example.cov.b4xtable._b4xtablecolumn)(_clvdata._getvalue(_clvindex))) == false) { 
...
public String  _resizecolumnimpl(b4a.example.cov.b4xtable._b4xtablecolumn _c,int _totalheight) throws Exception{
float _height = 0f;
int _topint = 0;
int _heightint = 0;
int _i = 0;
...
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
_p.setObject((java.lang.Object)(_c.CellsLayouts /*anywheresoftware.b4a.objects.collections.List*/ .Get(_i)));
...
public ResumableSub_SearchField_TextChanged(b4a.example.cov.b4xtable parent,String _old,String _new) {
this.parent = parent;
this._old = _old;
this._new = _new;
}
...
public ResumableSub_SetData(b4a.example.cov.b4xtable parent,anywheresoftware.b4a.objects.collections.List _data) {
this.parent = parent;
this._data = _data;
}
b4a.example.cov.b4xtable parent;
...
if (index7 < groupLen7) {
this.state = 9;
_column = (b4a.example.cov.b4xtable._b4xtablecolumn)(group7.Get(index7));}
if (true) break;
...
b4a.example.cov.b4xtable._b4xtablecolumn _col = null;
...
;
for (; index1 < groupLen1;index1++){
_col = (b4a.example.cov.b4xtable._b4xtablecolumn)(group1.Get(index1));
