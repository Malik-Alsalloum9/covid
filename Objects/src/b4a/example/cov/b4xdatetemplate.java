...
public class b4xdatetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.cov.b4xdatetemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.example.cov.b4xdatetemplate.class).invoke(this, new Object[] {null});
        else
...
public b4a.example.cov.b4xdialog _mdialog = null;
...
_mdialog = new b4a.example.cov.b4xdialog();
...
public String  _show(b4a.example.cov.b4xdialog _dialog) throws Exception{
...
if (BA.fastSubCompare(sub, "SHOW"))
	return _show((b4a.example.cov.b4xdialog) args[0]);
