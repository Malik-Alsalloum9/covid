...
public class httputils2service extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "b4a.example.cov", "b4a.example.cov.httputils2service");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.cov.httputils2service", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
b4a.example.cov.httpjob _job = null;
...
_job = (b4a.example.cov.httpjob)(_taskidtojob.Get((Object)(_taskid)));
...
anywheresoftware.b4a.keywords.Common.LogImpl("31966081",("ResponseError. Reason: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_reason))+", Response: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_response.getErrorResponse()))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("31572872",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 //BA.debugLineNum = 22;BA.debugLine="Log(\"Switching to File.DirInternal\")";
anywheresoftware.b4a.keywords.Common.LogImpl("31572873","Switching to File.DirInternal",0);
...
public static String  _submitjob(b4a.example.cov.httpjob _job) throws Exception{
